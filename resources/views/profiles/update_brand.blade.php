...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{$user->username}} Please Update Your Brand</div>

                <div class="card-body">
                    <form method="POST" action="/profile/d/{{$user->id}}">
                        @csrf
                        @method("PATCH")

                        <div class="row mb-3">
                            <label for="title" class="col-md-4 col-form-label text-md-end">Brand Name</label>
                        ...
                        <div class="row mb-3">
                            <label for="description" class="col-md-4 col-form-label text-md-end">Brand Description</label>
                            ...
                            <label for="url" class="col-md-4 col-form-label text-md-end">Website</label>
